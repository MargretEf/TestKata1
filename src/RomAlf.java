 class RomAlf {
        ...
        public static String [] alfavitRom = {"O", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X",
        ...
        public static boolean isAlfRom(String n){
            for (int q=0; q < alfavitRom.length; q++) {
                if (n.equals(alfavitRom[q])) {
                    return true;
                }
            }
            return false;
        ...
        public static String isConvert(int res){
            return  alfavitRom[res];
        }
    }
